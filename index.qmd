...
In this section we will create two tables: the first, weighted from
demographics (using `sampling_weight`), and the second weighted based on the
attrition (`ipw_w4`) associated with the fourth wave (W4).
